        ...
        for instruction in instruction_type:
            ...
            for article in articles:
                ...
                try:
                    ...
                    print(f"Skipping an article due to JSONDecodeError - {article['link']}")
                    continue
